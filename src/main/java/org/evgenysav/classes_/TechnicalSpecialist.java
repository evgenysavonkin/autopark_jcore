...
public class TechnicalSpecialist {
    ...
    private final int LOWER_LIMIT_MANUFACTURE_YEAR = 1886;

    public boolean validateManufactureYear(int year) throws NotVehicleException {
    ...
    public boolean validateMileage(int mileage) throws NotVehicleException {
        if (mileage >= 0) {
            return true;
        }
    ...
    public boolean validateWeight(int weight) throws NotVehicleException {
        if (weight >= 0) {
            return true;
        }
    ...
    public boolean validateColor(Color color) throws NotVehicleException {
        if (color != null) {
            return true;
        }
    ...
    public boolean validateVehicleType(VehicleType vehicleType) throws NotVehicleException {
    ...
    public boolean validateRegistrationNumber(String number) throws NotVehicleException {
        if (number == null) {
    ...
    public boolean validateModelName(String name) throws NotVehicleException {
    ...
    public boolean validateGasolineEngine(GasolineEngine engine) throws NotVehicleException {
        return validateCombustionEngine(engine);
    }

    public boolean validateElectricalEngine(ElectricalEngine engine) throws NotVehicleException {
    ...
    public boolean validateDieselEngine(DieselEngine engine) throws NotVehicleException {
        return validateCombustionEngine(engine);
    }

    private boolean validateCombustionEngine(CombustionEngine engine) throws NotVehicleException {
        if (engine.getTypeOfEngine() == null || engine.getTypeOfEngine().isEmpty()) {
